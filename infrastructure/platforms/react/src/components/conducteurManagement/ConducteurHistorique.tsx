// infrastructure/platforms/react/src/components/conducteurManagement/ConducteurHistorique.tsx
import { useState } from 'react';
import { HistoriqueEssai } from '../../types';
...
interface ConducteurHistoriqueProps {
  essais: HistoriqueEssai[];
  isOpen: boolean;
  onClose: () => void;
}

export function ConducteurHistorique({ essais, isOpen, onClose }: ConducteurHistoriqueProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="mb-4">
          <Select value={filtreType} onValueChange={(value: 'TOUS' | 'AVEC_INCIDENT' | 'SANS_INCIDENT') => setFiltreType(value)}>
            <SelectTrigger>
                          ...
                          <dl className="space-y-2">
                            <div className="flex justify-between">
                              ...
                              <dd className={
                                ...
                                incident.gravite === 'MAJEUR' ? 'text-amber-600' :
                                'text-yellow-600'
                              }>
                                {incident.type}
                              </dd>
